...
export PHP81_VER=8.1.25
export PHP82_VER=8.1.12
export PHP83_VER="8.3.0RC5"
export PHP84_VER="8.4.0-dev"
...
export PHP84_DL_URL="https://github.com/php/php-src/archive/f27090cbc231dbff7bd71452b9cc48ee2c379dcb.zip"
...
spt(){ apt install --no-install-recommends -y $* ; }
