...
Install_rsync()
{
	...
	wget -O $pluginPath/rsync_main.so $download_Url/install/plugin/rsync/rsync_main.so -T 5
	wget -O $pluginPath/rsync_main.cpython-36m-x86_64-linux-gnu.so $download_Url/install/plugin/rsync/rsync_main.cpython-36m-x86_64-linux-gnu.so -T 5
	wget -O $pluginPath/rsync_main.cpython-37m-x86_64-linux-gnu.so $download_Url/install/plugin/rsync/rsync_main.cpython-37m-x86_64-linux-gnu.so -T 5
