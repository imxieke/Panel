...
###
# @Author: Cloudflying
# @Date: 2023-09-08 22:52:49
# @LastEditTime: 2024-04-27 11:44:11
# @LastEditors: Cloudflying
# @Description: Compile PHP 8.1
###
...
PREFIX_PHP=${DOCKENV_PREFIX}/php/80
...
if [[ ! -f "/usr/lib/x86_64-linux-gnu/libsybdb.a" ]]; then
  ln -sf /usr/lib/x86_64-linux-gnu/libsybdb.* /usr/lib/
fi
